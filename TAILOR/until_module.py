...
def get_cls_loss(predicted_scores, emo_label):
    '''
    shape of predicted_scores: (batch_size, num_classes)
    shape of emo_label: (batch_size, num_classes)
    '''
...
def get_kt_loss(t, v, a, label, dynamic_weight=None, supervised_weights=0):
    '''
    shape of t: (batch_size, length, hidden_size) -> (B, L*H)
    shape of v: (batch_size, length, hidden_size) -> (B, L*H)
    shape of a: (batch_size, length, hidden_size) -> (B, L*H)
