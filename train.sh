...
# baseline
python train.py --data mosei --model Early --eval_mode micro --learning_rate 1e-5 --dropout 0.6 --use_bert False --use_kt False --use_confidNet False --device cuda:1 --batch_size 32 --n_epoch 40
...
# baseline
# python train.py --data mosei --model TAILOR --eval_mode micro --learning_rate 1e-5 --dropout 0.6 --use_kt False --use_confidNet False --device cuda --batch_size 8 --n_epoch 40
